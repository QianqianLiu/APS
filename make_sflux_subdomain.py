#!/usr/bin/env python3
#build sflux directory based on era5
from pylib import *
close("all")
...
#inputs
#---------------------------------------------------------------------------
StartT=datenum(2001,1,1); EndT=datenum(2002,1,1)
xm=[-91,-85]; ym=[25.5,31]

sdir='/expanse/lustre/projects/ncs124/liuz1/ERA5' #era5 source on sciclone
tdir='/expanse/lustre/projects/ncs124/liuz1/ERA5/ngom/sflux'   #target dir
...
for irec,ti in enumerate(mtime):
    ...
    for m,svar in enumerate(svars):
        fname='{}/{}/era5_{}.{:02d}_{:02d}_{:02d}.nc'.format(sdir,year,svar,year,month,day)
