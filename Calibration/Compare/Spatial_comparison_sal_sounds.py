...
salt_dif1 = H.salt.val.data[0,:,20] - C.salt.val.data[0,:,20]
...
salt_dif2 = C2.salt.val.data[0,:,20] - H2.salt.val.data[0,:,20]
...
gd.plot(fmt=1,value=salt_dif1,clim=[-2,2],ticks=11)
title('08-29; {}-{} WL'.format(hindcast_name,compare_name))
setp(gca(),xlim=[-77.397,-75.377],ylim=[34.537,35.617])

subplot(1,2,2)
gd.plot(fmt=1,value=salt_dif2,clim=[-2,2],ticks=10)
title('10-28; {}-{} WL'.format(hindcast_name, compare_name))
setp(gca(),xlim=[-77.397,-75.377],ylim=[34.537,35.617])

plt.subplots_adjust(top=0.75)
plt.suptitle('Spatial Comparison of Salinity - {} v {} Hindcast - Pamlico Sound'.format(hindcast_name, compare_name), fontsize = 20)

savefig('/expanse/lustre/projects/unc108/kboot/ModelResults/{}/figures/Salt_Spatial_{}v{}_pamlico.png'.format(compare_model, hindcast_name, compare_name))
...
setp(gca(),xlim=[-76.894,-75.278],ylim=[35.467,36.798])
plt.subplots_adjust(top=0.75)
plt.suptitle('Spatial Comparison of Salinity - {} v {} Hindcast - Albemarle Sound'.format(hindcast_name, compare_name), fontsize = 20)

savefig('/expanse/lustre/projects/unc108/kboot/ModelResults/{}/figures/Salt_Spatial_{}v{}_albemarle.png'.format(compare_model, hindcast_name, compare_name))
