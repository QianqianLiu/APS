...
#inputs
#---------------------------------------------------------------------------
StartT=datenum(2019,1,1); EndT=datenum(2020,1,1)
xm=[-80,-70]; ym=[32,38]

sdir='../../NARR_sflux_2019' #era5 source on sciclone
tdir='../../NARR_sflux_2019_sub'   #target dir
...
for irec,ti in enumerate(mtime):
    ...
    for m,svar in enumerate(svars):
        fname='{}/sflux_{}_{}.{:04d}.nc'.format(sdir,svar,itag,irec+1)
