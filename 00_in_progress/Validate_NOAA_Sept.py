...
obs = loadz("/home/liuquncw/Database_Zhengui/elev/noaa_elev_navd.npz")
...
mod = loadz('/expanse/lustre/projects/unc107/kboot/ModelResults/RUN04d/mod_at_noaa_stations.npz')
