function [out_east,out_north] = my_project_NC(in_east,in_north,direction) 
...
m_proj('UTM','longitude',[-79,-72],'latitude',[32,40],'zone',18,'hemisphere','north','ellipsoid','wgs84')
