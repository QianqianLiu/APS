...
#input
#------------------------------------------------------------------------------
######grd='/home/liuq/schism/APS/RUN01c/hgrid.gr3'        #hgrid name (grid.npz, or hgrid.gr3)
grd = 'input/hgrid.gr3'
vgname = 'input/vgrid.in'
fgname = 'input/Master_Grid'
#hsm: depth for each master grid;  nv: number for layers for each depth
# the maximum depth for our grid is 4400 m
#hsm=array([0.5,1.0,1.5, *arange(2,11),*[11.5,14,17,21],*arange(25,51,5),*arange(60,81,10),95,125])

#hsm=array([2,4,7,10,30,50,90,140,200,280,380,500,640,800,980,1180,1500,1670, 1960, 2280,2630,3010,3420,3850,4310,4600])
hsm=array([1.5,3,4.5,6,8,10,30,50,90,140,200,280,380,500,640,800,980,1180, *arange(1380,4200, 250), 4400])
